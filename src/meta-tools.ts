...
import { buildInputSchema, executeTool, ToolDef, McpTool } from "./tools.js";
  ...
  return [
    {
      ...
      description:
        "Search available Lark/Feishu tools by keyword. Returns matching tool names and descriptions. Use this to discover tools before calling them.",
      inputSchema: {
        type: "object",
        properties: {
          query: {
    ...
    },
    {
      ...
      description:
        "Get the full input schema for a specific Lark tool by name. Use after searching to understand what parameters a tool accepts.",
      inputSchema: {
        type: "object",
        properties: {
          tool_name: {
    ...
    },
    {
      name: "lark_invoke",
      description:
        "[read|write] Invoke any Lark tool by name. Use after lark_search_tools + lark_get_tool_schema to call tools not in the high-frequency set. Pass the exact tool_name and its args object.",
      inputSchema: {
        type: "object",
        required: ["tool_name"],
        properties: {
